...
void *__hxcpp_get_proc_address(String inLib, String full_name,bool inNdllProc,bool inQuietFail)
{
   ...
   if (!sgLibPathIsInit)
   {
      ...
      sgLibPath.push_back( HX_CSTRING("./lib/arm64/") );
      sgLibPath.push_back( HX_CSTRING("./lib/armv7/") );
      sgLibPath.push_back( HX_CSTRING("./lib/arm/") );
      sgLibPath.push_back( HX_CSTRING("./lib/x86/") );
      #endif
   }
